...
{
  auto *smd = reinterpret_cast<SDFRoundModifierData *>(md);
...
{
  modifier_panel_register(region_type, eModifierType_SDFRound, panel_draw);
}

static void blend_write(BlendWriter *writer, const ID * /*id_owner*/, const ModifierData *md)
{
  const auto *smd = reinterpret_cast<const SDFRoundModifierData *>(md);
