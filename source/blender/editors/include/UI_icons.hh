...
DEF_ICON_OBJECT_DATA(SDF_DATA)
DEF_ICON_OBJECT_DATA(NURB_BODY_DATA)
...
DEF_ICON_OBJECT(OUTLINER_OB_SDF)
DEF_ICON_OBJECT(OUTLINER_OB_NURB_BODY)
DEF_ICON_OBJECT(SDF_CUBE)
DEF_ICON(SDF_BLEND_LINEAR)
DEF_ICON(SDF_BLEND_SMOOTH)
DEF_ICON(SDF_BLEND_CHAMFER)
DEF_ICON(SDF_BLEND_ROUND)
DEF_ICON(SDF_CSG_UNION)
DEF_ICON(SDF_CSG_SUBTRACT)
DEF_ICON(SDF_CSG_INTERSECT)
DEF_ICON(SDF_CSG_EXTRUDE)
DEF_ICON(SDF_CSG_PUSH)
DEF_ICON(SDF_CSG_AVOID)
DEF_ICON_OBJECT(SDF_SPHERE)
DEF_ICON_OBJECT(SDF_CYLINDER)
DEF_ICON_OBJECT(SDF_CONE)
DEF_ICON_OBJECT(SDF_CAPSULE)
DEF_ICON_OBJECT(SDF_TORUS)
DEF_ICON_OBJECT(SDF_NGON)
DEF_ICON_OBJECT(SDF_POLYGON)
DEF_ICON(SDF_GROUP)
DEF_ICON_OBJECT(NURB_BODY_BOX)
DEF_ICON_OBJECT(NURB_BODY_SPHERE)
DEF_ICON_OBJECT(NURB_BODY_CYLINDER)
DEF_ICON_OBJECT(NURB_BODY_CONE)
DEF_ICON_OBJECT(NURB_BODY_TORUS)
DEF_ICON_OBJECT(NURB_BODY_WEDGE)
