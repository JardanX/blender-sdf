 ...
 */
inline constexpr int EDGE_PAIRS[12][2] = {
...
class Cell {
 public:
   ...
   * Keys are the edge indices (0-11) defined by the global EDGE_PAIRS array. */
  ...
  /* Initializes ix, iy, iz, corners, cornerSDF, and empty hermite data,
   * and also has_vertex if there are sign changes. */
  Cell(int i,
       int j,
       int k,
  ...
  void fill_hermite_data(const TrueSdfFunc *true_sdf = nullptr,
  ...
  void minimize_qef(double mu = 0.01,
