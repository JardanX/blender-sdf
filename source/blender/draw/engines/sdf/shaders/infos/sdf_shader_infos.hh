...
STORAGE_BUF(4, read, int4, active_coarse_chunks[])
STORAGE_BUF(5, read_write, HashEntry, hash_table[])
...
PUSH_CONSTANT(int, active_chunk_count)
PUSH_CONSTANT(int3, brick_offset)
...
STORAGE_BUF(4, read, HashEntry, hash_table[])
PUSH_CONSTANT(float, voxel_size)
PUSH_CONSTANT(float3, atlas_origin)
...
PUSH_CONSTANT(int, bvh_node_count)
PUSH_CONSTANT(float, bounds_margin)
...
STORAGE_BUF(2, read, HashEntry, hash_table[])
