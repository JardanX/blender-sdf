...
STORAGE_BUF(6, read, ChunkPageGPU, chunk_pages[])
STORAGE_BUF(7, read_write, int, chunk_bricks[])
STORAGE_BUF(8, read, int, free_slots[])
...
PUSH_CONSTANT(int, chunk_count)
PUSH_CONSTANT(int, dispatch_width)
PUSH_CONSTANT(int, max_active_bricks)
PUSH_CONSTANT(int, max_atlas_slots)
PUSH_CONSTANT(int, incremental_mode)
PUSH_CONSTANT(int, free_slot_count)
PUSH_CONSTANT(int, next_slot_base)
...
DO_STATIC_COMPILATION()
LOCAL_GROUP_SIZE(16, 16, 1)
STORAGE_BUF(0, read_write, BrickCounter, brick_counter)
STORAGE_BUF(1, write, ActiveBrick, active_bricks[])
STORAGE_BUF(2, read, ChunkPageGPU, chunk_pages[])
STORAGE_BUF(3, read_write, int, chunk_bricks[])
PUSH_CONSTANT(float, voxel_size)
PUSH_CONSTANT(float3, grid_world_min)
PUSH_CONSTANT(float3, grid_world_max)
PUSH_CONSTANT(int, chunk_count)
PUSH_CONSTANT(int, dispatch_width)
PUSH_CONSTANT(int, max_active_bricks)
TYPEDEF_SOURCE("sdf_shader_shared.hh")
...
STORAGE_BUF(2, read, ChunkPageGPU, chunk_pages[])
STORAGE_BUF(3, read, BVHNodeGPU, chunk_bvh_nodes[])
STORAGE_BUF(4, read, int, chunk_grid_lookup[])
STORAGE_BUF(5, read, SDFModifierGPU, sdf_modifiers[])
PUSH_CONSTANT(float, voxel_size)
PUSH_CONSTANT(float3, atlas_origin)
PUSH_CONSTANT(float3, atlas_extent)
PUSH_CONSTANT(int3, chunk_grid_resolution)
PUSH_CONSTANT(int3, atlas_chunk_min)
PUSH_CONSTANT(int, bricks_per_axis)
PUSH_CONSTANT(int, chunk_march_mode)
PUSH_CONSTANT(int, chunk_hash_mask)
PUSH_CONSTANT(int, chunk_bvh_node_count)
PUSH_CONSTANT(int, debug_grid_mode)
PUSH_CONSTANT(int, incremental_status)
PUSH_CONSTANT(int, dirty_brick_count)
PUSH_CONSTANT(int3, dirty_brick_min)
PUSH_CONSTANT(int3, dirty_brick_max)
