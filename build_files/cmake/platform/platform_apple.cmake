...
# Prevent Homebrew/MacPorts from leaking transitive dependencies into the build.
if(EXISTS /opt/homebrew)
  list(APPEND CMAKE_IGNORE_PREFIX_PATH /opt/homebrew)
endif()
if(EXISTS /usr/local/Cellar)
  list(APPEND CMAKE_IGNORE_PREFIX_PATH /usr/local /usr/local/Cellar)
endif()
if(EXISTS /opt/local)
  list(APPEND CMAKE_IGNORE_PREFIX_PATH /opt/local)
endif()
